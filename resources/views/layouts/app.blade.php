...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/front1.css')}}">
    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <span class="logo_back"><a href="/">Test Your Skill</a></span>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    @can('admin')
                    <li class="dropdown">
                        <a href="{{ url('/home') }}" class="dropdown-toggle"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quiz  <span class="caret"></span></a>
